...
// Lembrete: na sua home, troque os hrefs dos botões "Membro" e "Recrutador"
// de /membro e /recrutador para /registro?role=member e /registro?role=recruiter.
// Isso ativa o modal (via intercepting route) quando clicado a partir da home.
